...
class MainTabBarController: UITabBarController {
    ...
    private let homeVC = UINavigationController(rootViewController: HomePageViewController())
    private let styleVC = UIViewController()
    private let shopVC = UINavigationController(rootViewController: ItemDetailViewController())
